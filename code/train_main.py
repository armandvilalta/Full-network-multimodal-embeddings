...
Write results in a file named in line 70, res_filename
"""

#import train, tools, evaluation, experiment management
...
print ('VALIDATION:')
if n_fold < 2:
    print ('No need to compute n-fold validation, using training results on one fold')
else:
...
print ('TEST:')
params['best_test_res'], params['best_test_score'] = ranking_eval_Nfold(model, n_fold, subset='test')
